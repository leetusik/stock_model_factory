...
def train():
    ...
    # --- THE FIX: TIME SERIES SPLIT ---
    # We want to train on the Past (first 80%) and validate on the Future (last 20%)
    ...
    # Create Subsets using specific indices (NOT Random)
    ...
    for epoch in range(EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "models/vcp_cnn_best_2.pth")
            print("  >>> Model Saved!")
